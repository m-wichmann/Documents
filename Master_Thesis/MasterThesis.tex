...
\begin{figure}[h]
    ...
    \caption{ARINC 653 Architektur Übersicht\cite{arinc653_wr}}
    \label{fig:arinc_653}
\end{figure}
...
% - ARINC
% - Micorkernel
% - Para virt ähnlich XEN
% - DO-178B, ISO 26262 zertifiziert
% - Linux, RTOS, POSIX, ARINC, AUTOSAR, Java
% - PPC, X86, ARM, MIPS, SPARC
% - Multi-Core
% - Cert IP stack and file system
% - Eclipse IDE
% - Echtzeitfähig
% - Comm encryption
% - Health monitoring
...
% OKL4
% \cite{okl4}
% - Mobile Phone (750 Million instances shipped)
% - Linux, Symbian, Windows Mobile
