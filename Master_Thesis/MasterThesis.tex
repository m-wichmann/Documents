...
????: 0x1B00000D - 0D:00:04:00:00:00:00:00
BCM : 0x1B00000E - 0E:00:08:01:11:00:0C:00
\end{lstlisting}

Für einen ersten Einstieg, sind in Listing \ref{lst:nm_botschaften} einige Beispiel-Botschaft des Netzwerk-Managements zu sehen. Dort ist nach dem Node-Namen, die CAN-ID der Botschaft aufgeführt. Diese beginnen bei 0x1B000000 und enthalten im letzten Teil auch eine Node-ID. Diese ID ist in der eigentlichen Botschaften im ersten Byte wiederzufinden. Das zweite Byte hat immer den Wert null, während das dritte Byte anscheinend einen Status angibt. Diese Werte ändern sich, je nach System-Status. Diesen kann zum Beispiel die Klemme 15 ändern, und damit das Einschlafen des Bus-Systems veranlassen. Alle weiteren Bytes sind ausschließlich beim BCM-Node ungleich null. Diese ersten Beobachtungen des Protokolls werden nun anhand der AUTOSAR-Spezifikation untersucht.
...
% - Bild des Modells
% - Welche Botschaften wurden eingesetzt?
% - Liste der App Signale


% TODO: evtl. Runnable noch in das Bild?! Wäre aber zu voll dann...
\begin{figure}[ht]
\centering
...
Tabelle \ref{tab:App_Botschaft} zeigt die Signale der Botschaft APP\_01. Diese Botschaft hat die ID 0x742, eine Länge von 4 Byte, und wird mit einer Zykluszeit von 100 ms gesendet.
