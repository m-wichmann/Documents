...
%\usepackage{chronology}         % Chronologien zeichnen (http://www.tug.org/texlive/devsrc/Master/texmf-dist/tex/latex/chronology/chronology.sty)
%\usepackage{timeline}
...
Gesetzt mit Hilfe von {\KOMAScript} und {\LaTeX}. LibreOffice für die \\ Textverarbeitung und gedit als Editor. Xubuntu als offenes Betriebssystem. \\ \\ Diese Arbeit ist freigegeben unter der Creative Commons CC-BY-SA Lizenz\cite{CCBYSA} und ist zum Teil im Internet erreichbar\cite{github}.
}
...
% TODO: Tabelle durch Zeitleiste ersetzen?!
%\begin{chronology}[5]{2000}{2015}{3ex}{0.7\textwidth}
%  \event{1984}{one}
%  \event[1985]{1986}{two}
%  \event{\decimaldate{8}{7}{2005}}{1.0}
%  \event{\decimaldate{4}{5}{2006}}{2.0}
%  \event{\decimaldate{4}{12}{2006}}{2.1}
%  \event{\decimaldate{21}{12}{2007}}{3.0}
%  \event{\decimaldate{15}{8}{2008}}{3.1}
%  \event{\decimaldate{18}{12}{2009}}{4.0}
%  \event{\decimaldate{13}{5}{2011}}{3.2}
%  \event{\decimaldate{15}{4}{2011}}{4.0.2}
%  \event{\decimaldate{22}{12}{2011}}{4.0.3}
%\end{chronology}
%\begin{timeline}{2000}{2015}{100}{200}
%  \MonthAndYearEvent{7}{2005}{1.0}
%  \MonthAndYearEvent{5}{2006}{2.0}
%  \MonthAndYearEvent{12}{2006}{2.1}
%  \MonthAndYearEvent{12}{2007}{3.0}
%  \MonthAndYearEvent{8}{2008}{3.1}
%  \MonthAndYearEvent{12}{2009}{4.0}
%  \MonthAndYearEvent{5}{2011}{3.2}
%  \MonthAndYearEvent{4}{2011}{4.0.2}
%  \MonthAndYearEvent{12}{2011}{4.0.3}
%\end{timeline}
...
3.1	  & 15.08.2008 &  & \\
      & 2008       &  & Erste Autos mit Autosar\\
4.0	  & 18.12.2009 &  & \\
\midrule
3.2	  & 13.05.2011 & \multirow{3}{*}{Phase III} & \\
4.0.2 & 15.04.2011 &  & \\
4.0.3 & 22.12.2011 &  & \\
\bottomrule
\end{tabular}
...
% TODO: muss das so mit dem paragraph???
\paragraph*{}
