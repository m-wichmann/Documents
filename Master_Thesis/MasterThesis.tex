...
%   - SMLS 1B00000C - 0C 00 04 00 00 00 00 00 <- 1. Byte: Node ID; 3. Byte: Status?!
%   - BCM  1B00000E - 0E 00 08 01 11 00 0C 00 <- 1. Byte: Node ID; 3. Byte: Status?!; Rest unklar!
% - Nötige AUTOSAR Änderungen
%   - DBC und ARXML anpassen und importieren
%   - Add modules: CanNm, CanSm, ComM, Nm
%   - Nm: ComM Channel einstellen
%   - CanNm: Node Identifier (aktivieren, wert zuweisen, Position zuweisen)
%   - Rte_Call_UserReuqest_RequestComNode(FULL_COMMUNICATION oder NO_COMMUNICATION)


% - NM PDU senden wenn SRC-Node Bus wach haben möchte; Wenn nicht mehr -> keine NM mehr senden aber wach bleiben bis alle anderen aufhören
% - default NM-PDU Format: ID, Control bit vector, User data 0 - 5 [Seite 51, AUTOSAR CANNM]

% CanSM überwacht Bus etc. -> z.b. BUSOFF

% Warum ist NM nötig?
% Projekt-Spezifischer Kram -> Welche IDs waren nötig
...
% App_01 0x742 4 Byte 100ms
% APP_Blinker_li          1   0   1
% APP_Blinker_re          1   1   1
% APP_Lichthupe           1   2   1
% APP_Fernlicht           1   3   1
% APP_Demo0               2   0   1
% APP_Demo0_Peridoe_li    3   0   4
% APP_Demo0_Periode_re    3   4   4
% APP_Demo1               4   0   1
% APP_Demo1_Periode       4   4   4
