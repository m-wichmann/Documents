...
%   - Technik bereits fortgeschritten
%   - ARINC 653 demonstriert Konzept schon länger
...
%   - Virtualisierung könnte Konzept vereinheitlichen
%   - "Bausatz-System"
% - Kurze "time-to-market" durch Evaluation auf Windows/Linux Platformen
% - Testen kann vereinheitlicht werden -> RBS durch VMs
% - WinCore ist einfach zu verwenden
%   - Erster Aufwand aufgrund embedded Plattform entfällt
%   - Vor allem interessant für Lehre da simpel und schnell
%   - VCAN Zugriff (per Python)
% - Portierungsaufwand kann verteilt werden
