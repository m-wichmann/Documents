...
\label{sec:Relevanz}
% TODO: multicore ist toll!
% - Motivation 
%   - Infotainment, Fahrerassitenzsysteme etc brauchen immer mehr Leistung/"Libraries" -> Sicherheit -> Virtualisierung sinnvoll!
...
% TODO:
% - Kurze "time-to-market" durch Evaluation auf Windows/Linux Plattformen
...
% TODO
% - Da VCAN nur in Evaluation -> Nicht kritisch
% - Angriffe auf Ethernet genauso wie auf CAN möglich -> Physikalischer Schutz nötig
% - Ausfall Hypervisor -> Ausfall System
...
% - VCAN bietet noch viele Möglichkeiten für weitere Projekte (DBC/SD import, Test, RBS, Anbindung an "Kram")
