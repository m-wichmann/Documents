...
% - WxWidget oder pygame für konstante timer -> jitter von 1 ms möglich (unter Linux)
% - pygame besser als wxwidget
\begin{figure}
    \centering
...
% AUTOSAR zum Teil sehr viel schlechter (Senden in Bursts) konnte jedoch heir nicht gezeigt werden.
\begin{table}[ht]
    \centering
